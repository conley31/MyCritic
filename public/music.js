...
var populateHtml = function(){
    ...
    for(var i = 0; i < 50; i++){
       // html += "<div id=\"" + i + "\" style=\"margin-left: 10%; border-bottom-style: solid; border-width: 2px\"; onclick=\"window.location=\'/song/" + trackObj[i].tracks.items[0].id + "\'\"'><h1>" + trackObj[i].tracks.items[0].name + "</h1></div>";
        ...
        html += "<div id=\"" + i + "\"onmouseout=\"this.style.color=\'black\'\" onmouseover=\"this.style.color=\'#4b6d93\'; this.style.cursor=\'pointer\' \" style=\"margin-left: 25%; margin-bottom: 2%; width: 50%; background-color: \'white\';\"; onclick=\"window.location=\'/song/"
