...
$.getJSON(url, function(json){
	...
	var html = "";
	for( i = 0; i < 20; i++){
		html += "<div style=\"margin-left: 10%; border-bottom-style: solid; border-width: 2px\"; onclick=\"window.location=\'/book/" + json["results"][i]["title"] + "\'\"'><h1>" + json["results"][i]["title"] + "</h1></div>";
	}
